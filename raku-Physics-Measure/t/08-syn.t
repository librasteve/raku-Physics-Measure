...
my $a1 = $d1 * $d2;
is $a1, '1.829 m^2',                                                            '$a-mul-mixed';

my $di1 = $d1 / $d2;
is "$di1", '2.187227',                                                          '$di1-div-mixed';

my $ad1 = $d1 + $d2;
is "$ad1", '2.914 m',                                                           '$ad1-add-mixed';

my $su1 = $d1 - $d2;
is "$su1", '1.086 m',                                                           '$su1-sub-mixed';
...
my $z2;
$z2 = $x2 * $y2;
is $z2, '0.061 Gy',                                             '$z2-mul-m.s-1*feet.mins-1';

$z2 = $x2 / $y2;
is $z2, '147.637795',                                           '$z2-div-m.s-1/feet.mins-1';

$z2 = $x2 + $y2;
is $z2, '3.02 m/s',                                             '$z2-add-m.s-1+feet.mins-1';

$z2 = $x2 - $y2;
is $z2, '2.98 m/s',                                             '$z2-sub-m.s-1+feet.mins-1';
