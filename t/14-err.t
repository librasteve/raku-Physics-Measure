...
my $maths31-re = <
-12.5ft ±1.312500e+00
12.50000410104987ft ±1.312500e+00
3810001249.99999982404nm ±4.000501e+08
29.5ft ±1.312500e+00
12.3ft ±1.312500e+00
1267nm ±5.375000e+01
12.49999589895013ft ±1.312500e+00
-3809998750.00000013402nm ±4.000501e+08
0ft ±2.625000e+00
0.000004763m^2 ±7.048500e-07
212.5ft ±2.231250e+01
3048000① ±4.511040e+05
>;
is check-maths( @o3-xs[1] ) eq $maths31-re, True,                'maths ok';

my Time $t = Time.new(value => 10, units => 'ms', error => '4.3%');
is ~$t, '10ms ±4.300000e-01',                                    'Time ms';
is ~( 17 / $t ), '1700Hz ±7.310000e-01',                         'Frequency Hz' ;

is ~( $y / $t ), '0.000125m/s ±1.075000e-05',                    'Speed m/s';

my Length $w = Length.new(value => 10, units => 'm', error => '2%');

my $z = $w ** 3;
is ~$z, '1000m^3 ±6.000000e+01',                                  'power';

$z = $z ** <1/3>;
is ~$z, '10m ±2.000000e-01',                                      'root';
